...
## Project Structure
    ...
    ├── testapiautostoryboa_65082  # Django project configurations
...
1. Clone this repo and `cd testapiautostoryboa_65082`
...
2. Clone this repo and `cd testapiautostoryboa_65082`
